...
import {
    ...
    createEstatisticaSchema,
    UpdateEstatisticaDTO,
    updateEstatisticaSchema,
...
export class EstatisticaService {
    ...
    async createEstatistica(data: CreateEstatisticaDTO) {
        const parsed = createEstatisticaSchema.safeParse(data);
    ...
    async updateEstatistica(estatisticaId: number, newEstatistica: UpdateEstatisticaDTO) {
        const parsed = updateEstatisticaSchema.safeParse(newEstatistica);
